...
runme ${runopt} -e ismip6 -n yelmox_ismip6/legacy/yelmo_ismip6_Antarctica.nml -o ${fldr} -p yelmo.grid_name=${grid_name} ${runpar} ${optpar}
...
runme ${runopt} -e ismip6 -n yelmox_ismip6/legacy/yelmo_ismip6_Antarctica.nml -o ${fldr} -p ctrl.run_step="spinup" spinup.equil_method="opt" yelmo.grid_name=${grid_name} ${paropt2} ${paropt}
...
runme ${runopt} -e ismip6 -n yelmox_ismip6/legacy/yelmo_ismip6_Antarctica.nml -o ${fldr}/${expname} -p ${runpar} ${optpar}
